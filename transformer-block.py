...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.multi_headed_self_attention = self.MultiHeadedSelfAttention(
            model_dim, num_heads
        )
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        first_part = embedded + self.multi_headed_self_attention(
            self.first_layer_norm(embedded)
        )

        res = first_part + self.feed_forward(self.second_layer_norm(first_part))
